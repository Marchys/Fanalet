...
namespace Pathfinding {
	...
	public struct IntRect {
		...
		public IntRect Rotate ( int r ) {
			var mx1 = Rotations[r*4+0];
			var mx2 = Rotations[r*4+1];
			var my1 = Rotations[r*4+2];
			var my2 = Rotations[r*4+3];
			
			var p1x = mx1*xmin + mx2*ymin;
			var p1y = my1*xmin + my2*ymin;
			
			var p2x = mx1*xmax + mx2*ymax;
			var p2y = my1*xmax + my2*ymax;
		...
		public void DebugDraw (Matrix4x4 matrix, Color col) {
			var p1 = matrix.MultiplyPoint3x4 (new Vector3(xmin,0,ymin));
			var p2 = matrix.MultiplyPoint3x4 (new Vector3(xmin,0,ymax));
			var p3 = matrix.MultiplyPoint3x4 (new Vector3(xmax,0,ymax));
			var p4 = matrix.MultiplyPoint3x4 (new Vector3(xmax,0,ymin));
